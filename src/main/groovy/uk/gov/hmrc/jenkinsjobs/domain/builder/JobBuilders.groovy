...
import static uk.gov.hmrc.jenkinsjobs.domain.variable.JavaVersionEnvironmentVariable.JDK8_40
...
final class JobBuilders {
    ...
    private static List<EnvironmentVariable> environmentVariables() {
        JavaVersionEnvironmentVariable javaVersionEnvironmentVariable = JDK8_40
