...
new BuildMonitorViewBuilder('PLATOPS-MONITOR')
        .withJobs('sbt-git-versioning', 'time', 'sbt-bobby', 'jenkins-job-builders', 'git-stamp', 'init-repository', 'releaser', 'govuk-template', 'sbt-bintray-publish', 'sbt-auto-build', 'sbt-git-stamp', 'sbt-settings', 'sbt-distributables', 'sbt-distributables-25', 'sbt-distributables-plugin-25', 'teams-and-services', 'catalogue-frontend', 'alert-config-builder', 'init-service', 'indicators', 'create-a-release', 'create-a-repository', 'create-a-webhook', 'github-client').build(this)
